...
export default function StaticSection3({ src = '', children }) {
  return (
    <div className="relative h-screen w-screen overflow-hidden">
      ...
      {/* РОВНО вместо overlays[idx]: кладёшь сюда любой JSX */}
      {children && (
       ...
       {/* Bottom Nav */}
                  <div className="absolute max-w-[1410px] mx-auto bottom-12 left-1/2 transform -translate-x-1/2 w-3/4 flex items-center justify-center bg-[#e5dccb] px-2 py-1 rounded-full z-50">
