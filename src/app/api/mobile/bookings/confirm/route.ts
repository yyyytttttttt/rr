...
/**
 * GET /api/mobile/bookings/confirm?token=xxx&bookingId=xxx
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.info(`[MOBILE_BOOKING_CONFIRM] Booking ${bookingId} confirmed via email`);
    ...
    console.error('[MOBILE_BOOKING_CONFIRM] Error:', error);
    return NextResponse.json(
