...
export async function GET(req: NextRequest) {
  ...
  console.log("[MOBILE_DOCTORS] GET request - query:", q, "page:", page, "pageSize:", pageSize);
  ...
  try {
    ...
    console.log(`[MOBILE_DOCTORS] Found ${doctors.length} doctors (total: ${total})`);

    return NextResponse.json({ items: doctors, total, page, pageSize });
  } catch (error) {
    console.error("[MOBILE_DOCTORS] Failed to fetch doctors:", error);
...
export async function POST(req: NextRequest) {
  ...
  console.log("[MOBILE_DOCTORS] POST request - creating new doctor");
