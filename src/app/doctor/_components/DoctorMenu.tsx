...
export default function DoctorMenu({ setOpen, currentView }: Props) {
  const router = useRouter();

  const handleNavigate = (view: View) => {
    router.replace(`/doctor?view=${view}`, { scroll: false });
    if (typeof window !== "undefined") localStorage.setItem("doctor_last_view", view);
    setOpen(false);
  };
